...
public class CartController {
	...
	public ResponseEntity<Cart> addItemToCart(@PathVariable Long userId,
			@RequestBody Map<String, Map<String, Integer>> payload, @PathVariable Long vendorId) {
		System.out.println("Received payload: " + payload);
		Map<String, Integer> itemQuantities = payload.get("itemQuantities");
	...
	public ResponseEntity<Cart> addItemToCartByCategory(@PathVariable Long userId,
			@RequestBody Map<String, Integer> itemQuantities, @PathVariable Long vendorId,
	...
	public ResponseEntity<Cart> updateCart(@PathVariable Long cartId, @PathVariable Long userId,
			@RequestBody Map<String, Integer> itemQuantities, @PathVariable Long vendorId) {
...
//    }
	...
	public ResponseEntity<Cart> updateCartBySideOns(@PathVariable Long cartId, @PathVariable Long userId,
			@RequestBody Map<String, Integer> itemQuantities, @PathVariable Long vendorId) {
		Cart updatedCart = cartService.updateCart(cartId, userId, itemQuantities, vendorId);
		return new ResponseEntity<>(updatedCart, HttpStatus.OK);
	}
	...
	public ResponseEntity<Cart> applyCouponToCart(@PathVariable Long cartId, @RequestParam CouponType couponType) {
